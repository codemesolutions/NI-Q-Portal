                ...
                if(is_null($m)){
                    ...
                    if($m->active == 1 && !is_null($m->finalized_date) && $m->genetic_test_results === 1 && $m->microbial_test_results === 1 && $m->toxicology_test_result === 1){
                        mail(
                            ...
                            "Your milk has passed testing and has been approved for payment. Ni-Q sincerely appreciates all that you have done.  Your efforts will go a long way to help save the lives of infants in need across the country. Please visit the portal for your milk kit details.<br />
                            First payment through Ni-Q comes in the form of a check, and all subsequent payments will be deposited directly into the account provided. Ni-Q will send a notification when this has been made. For payments dates, it is variable. It depends on when your kits are received, tested, and approved. Ni-Q understands it is not ideal, but we are unable to give donors specific payment dates. Ni-Q keeps laboratory and our team at maximum capacity to ensure timely completion of this phase. It is however a variable schedule as we cannot anticipate how much milk Ni-Q will receive each day, nor when each kit will be paid. Thank you again for all that you do in helping, Ni-Q to provide the highest safety and nutritional standards in the industry.<br />
                            Please, understand Ni-Q is not your employer. We recommend you consider this as auxiliary income, and do not rely on it as a scheduled paycheck. Refer to the consent form for reference. Ni-Q can assure you we make all efforts to get every donor compensated for their efforts as quickly as possible, and that we do appreciate your donation so very much! <br />

                            Sincerely, Ni-Q.<br /> <a href='https://portal.ni-q.com'>Click here to login into your donor account!</a>",
                            'From: erica@ni-q.com' . "\r\n" .
                            'Reply-To: erica@ni-q.com' . "\r\n" .
                            'X-Mailer: PHP/' . phpversion()."\r\n".
                            'MIME-Version: 1.0' . "\r\n".
