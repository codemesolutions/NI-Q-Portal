    ...
    <div style="height: calc(100% - 51.2px);" class="overflow-auto">
        ...
        <div class=" ">
            <div class="row  m-0 align-items-stretch">
                <div class="col-12 p-0">
                    <div class="border p-5 bg-white">
                        ...
                        <table class="table bg-white border-left border-right">
                            <tbody>
                                <tr>
                                    <td style="width: 200px;background: #f5f5f5; border-right: #ddd 1px solid;border-bottom: #ddd 1px solid;">Donor ID</td>
                                ...
                                <tr>
                                    <td style="width: 200px;background: #f5f5f5; border-right: #ddd 1px solid;border-bottom: #ddd 1px solid;">Received Consent Form</td>
                                    <td>{{$donor->recieved_consent_form == true ? "Yes":"No"}}</td>
                                </tr>
                                <tr>
                                    <td style="width: 200px;background: #f5f5f5; border-right: #ddd 1px solid;border-bottom: #ddd 1px solid;">Consent Form</td>
                                    <td><a href="/file/{{$donor->consent_form}}">Consent Form</a></td>
                                </tr>
                                <tr>
                                    <td style="width: 200px;background: #f5f5f5; border-right: #ddd 1px solid;border-bottom: #ddd 1px solid;">Received Financial Form</td>
                    ...
                    <div class="col-6 p-0">
                        <div class="border-left border-bottom p-5">
                            <div class="row m-0 bg-gradient border-top border-left border-right p-3">
                ...
                <div class="col-6 p-0">
                    <div class="h-100 border-left border-bottom p-5">
                        <div class="row m-0 bg-gradient border border-bottom-0 p-3">
