<div class="modal fade in" id="createselectinput" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content  border-0 bg-white ">
      ...
      <div class="modal-body  border p-3 p-md-5 bg-white shadow-lg ">
        ...
        <form class="addinputfield" method="POST" action="{{Route('admin.forms.page.field.save')}}">
             <div class="row m-0">
                <h6 class="m-0 text-uppercase" > <i class="fab fa-wpforms p-3 bg-primary text-white "></i> Create Select Dropdown Field</h6>
                ...
                <div class=" col-12 ">
                    ...
                    @if($errors->has('name') && old('modal') === "create-form-page")
                     ...
                     <div class="form-group mt-4">
                        <label>Options</label>
                       <textarea name="options" class="form-control form-control-lg" class="form-control form-control-lg {{$errors->has('options') && old('modal') === "create-form-page" ? 'is-invalid':''}}" value="{{old('options')}}"></textarea>
                       
                        @if($errors->has('options') && old('modal') === "create-form-page")
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('options') }}</strong>
                            </span>
                        @endif
                        <p class="small text-muted">Please seperate your options by a comma.</p>
                    </div>
