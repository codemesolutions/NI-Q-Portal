  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content  border-0 bg-white ">
      ...
      <div class="modal-body  border p-3 p-md-5 bg-white shadow-lg ">
        ...
        <form class="" method="POST" action="{{Route('admin.forms.page.save')}}">
             <div class="row m-0">
            ...
            <div class="row m-0 align-items-center bg-light border my-5 p-5">
                <div class=" col-12 ">
                    ...
                    <div class="form-group">
                        <label>URL</label>
                        <input type="text" name="url"  class="form-control form-control-lg {{$errors->has('url') && old('modal') === "create-form-page" ? 'is-invalid':''}}" value="{{old('url')}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description"  class="form-control form-control-lg {{$errors->has('description') && old('modal') === "create-form-page" ? 'is-invalid':''}}" value="{{old('description')}}"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keywords"  class="form-control form-control-lg {{$errors->has('keywords') && old('modal') === "create-form-page" ? 'is-invalid':''}}" value="{{old('keywords')}}"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="redirect"  class=" link-url form-control form-control-lg {{$errors->has('redirect') && old('modal') === "create-form-page" ? 'is-invalid':''}}" value="{{old('redirect')}}"/>
