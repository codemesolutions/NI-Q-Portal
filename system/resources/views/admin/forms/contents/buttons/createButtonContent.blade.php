<div class="modal fade in" id="createbutton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class=" col-12 ">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-lg  {{$errors->has('type') && old('modal') === "create-form-page" ? 'is-invalid':''}}" name="type">
                            ...
                            <option value='button.submit'>Form Submit</option>
