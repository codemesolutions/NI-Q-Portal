...
<div class="bg-white h-100">
     <div class="bg-dark px-3 py-3 row m-0 align-items-center">
        ...
        <a href="/admin/menu-item/update?id={{$data_item->id}}" class="btn btn-warning btn-sm ml-auto mr-1 text-white"><i class="fas fa-pencil-alt"></i> Edit Menu Item</a>
        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-trash"></i> Delete Menu Item</button>
    </div>
                    ...
                    <div class="col-12 row m-0">
                        <div class="col-6">
                            <div class="row m-0 bg-light border-top border-left border-right p-3">
                                <p class="m-0">Menu Item Information</p>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="row m-0 bg-light border border-bottom-0 p-3 align-items-center">
                                <p class="m-0">Menu Item Permissions({{$data_item->permissions()->count()}})</p>
  ...
  <div class="modal-dialog rounded-0" role="document">
    <div class="modal-content rounded-0">
      ...
      <div class="modal-footer">
        ...
        <a type="button" href="/admin/menu-item/delete?id={{$data_item->id}}" class="btn btn-success"><i class="fas fa-thumbs-up"></i> Delete</a>
      </div>
    </div>
  </div>
</div>
